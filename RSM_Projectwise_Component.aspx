<%@ Page Title="" Language="C#" MasterPageFile="~/UMM/MasterPage.master" AutoEventWireup="true" CodeFile="RSM_Projectwise_Component.aspx.cs" Inherits="RSM_Reports_RSM_Projectwise_Component" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%">
        <tr>
            <td colspan="6" class="tableheading"><span class="mainheadingborderbottom">Project wise Component Detail</td>
        </tr>
        <tr>
            <td class="vtext" style="width: 20%;">Research End Date(From)
            </td>
            <td class="colon">:
            </td>
            <td class="required">
            ...
            <td class="vtext" id="lblComdate">Research End Date(To)</td>
            <td class="colon">:
            </td>
            <td class="required">
