...
public partial class RSM_Reports_RSM_Projectwise_Component : System.Web.UI.Page
{
        ...
        {
            {
                ...
                if (str.ToUpper() == ds.Tables[0].Rows[0]["dbname"].ToString())
                    recieptviewer.ServerReport.ReportPath = "/" + ds.Tables[0].Rows[0]["Dirname"].ToString() + "/RPCAU_Reports" + "/RSM_ComponentBreakUp_Rpt";
                else
                    recieptviewer.ServerReport.ReportPath = "/" + ds.Tables[0].Rows[0]["DirnameTest"].ToString() + "/RPCAU_Reports" + "/RSM_ComponentBreakUp_Rpt";
