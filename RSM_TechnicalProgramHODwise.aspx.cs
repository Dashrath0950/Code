...
public partial class RSM_Reports_RSM_TechnicalProgramHODwise : System.Web.UI.Page
{
    ...
    void BindDepartment()
    {
        ...
        idr.Dispose();
        idr.Close();
        DataTable drq = new DataTable();
        DataView dv = dt.AsDataView();

        //if (Session["UserId"].ToString().Trim() == "LU-1")
        //{
        ...
        //else
        //{
        //    dv.RowFilter = "pk_userId ='" + Session["UserId"].ToString().Trim() + "'";
        //    drq = dv.ToTable();
        //    if (drq.Rows.Count > 0)
        //    {
        //        ddl_department.DataSource = drq;
        //        ddl_department.DataTextField = "description";
        //        ddl_department.DataValueField = "pk_deptid";
        //        ddl_department.DataBind();
        //        ddl_department.Items.Insert(0, "-- Select Department --");
        //        ddl_department.SelectedValue = drq.Rows[0]["pk_deptid"].ToString();
        //    }
        //    ddl_department.Items.Insert(0, "-- Select Department --");
        //}
    ...
    void fillgrid()//string status
    {
        ...
        {
            schemeid = 0;
            ClientMessaging("please select scheme");
            return;
        }
        else
        {
        ...
        {
            Section ="0";
            ClientMessaging("please select Section");
            return;
        }
        else
        {
            Section = D_ddlsector.SelectedValue.ToString();
    ...
    //
    //public static StoredProcedure RSM_Technical_Program_Reportupdated(string status, string pk_deptid, int pk_Scid, int pk_resid, string Fk_Locid, string xml, string columnName, string hodyear)
    //{
