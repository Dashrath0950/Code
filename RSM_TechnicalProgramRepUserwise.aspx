<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RSM_TechnicalProgramRepUserwise.aspx.cs" Inherits="RSM_Reports_RSM_TechnicalProgramRepUserwise" MasterPageFile="~/UMM/MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td>
                ...
                <Anthem:CheckBoxList ID="chkList" AutoUpdateAfterCallBack="true" runat="server" Style="color: #b92b27; display: inline-flex !important;"
                    RepeatDirection="Horizontal" CellSpacing="10" AutoCallBack="true" onclientclick="return onchange(this);">
        ...
        <tr>
            <td colspan="2"></td>
            <td colspan="4">
                <Anthem:Button ID="btnPrnt1" runat="server" TextDuringCallBack="WAIT..." Text="Print 1" AutoCallBack="true" OnClick="btnprnt_Click1" AutoUpdateAfterCallBack="true" EnableCallBack="false" />

                <Anthem:Button ID="btnprnt" runat="server" TextDuringCallBack="WAIT..." Text="Print 2" AutoCallBack="true" OnClick="btnprnt_Click" AutoUpdateAfterCallBack="true" EnableCallBack="false" />
