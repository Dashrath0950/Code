...
public partial class RSM_Reports_RSM_DistrictwiseTarget_Rpt : System.Web.UI.Page
{
    ...
    protected void Binddropdown()
    {
        try
        {
            ...
            //    ddldistrict.DataValueField = "pk_districid";
            //    ddldistrict.DataTextField = "description";
        ...
        {
            {
                ...
                if (str.ToUpper() == ds.Tables[0].Rows[0]["dbname"].ToString())
                    recieptviewer.ServerReport.ReportPath = "/" + ds.Tables[0].Rows[0]["Dirname"].ToString() + "/RPCAU_Reports" + "/RSM_Year_Target_Rpt";
                else
                    recieptviewer.ServerReport.ReportPath = "/" + ds.Tables[0].Rows[0]["DirnameTest"].ToString() + "/RPCAU_Reports" + "/RSM_Year_Target_Rpt";
                ...
                // reportParameterCollection[1] = new Microsoft.Reporting.WebForms.ReportParameter("fk_districtid", ddldistrict.SelectedValue);
