<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RSM_TechnicalProgramRep.aspx.cs" Inherits="RSM_Reports_RSM_TechnicalProgramRep" MasterPageFile="~/UMM/MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td class="colon">:</td>
            <td>
                <Anthem:DropDownList ID="ddl_department" runat="server" AutoUpdateAfterCallBack="true" SkinID="dropdown"
                    OnSelectedIndexChanged="ddl_department_SelectedIndexChanged" AutoCallBack="true">
                </Anthem:DropDownList>
            </td>
        ...
        <tr>
            ...
            <td colspan="4">
                ...
                <Anthem:Button ID="btnreset" runat="server" TextDuringCallBack="WAIT..." AutoUpdateAfterCallBack="true" OnClientClick="target ='_self';"
        ...
        <tr>
            ...
            <td colspan="4">
                ...
                <Anthem:Button ID="btnprnt" runat="server" TextDuringCallBack="WAIT..." Text="Print 2" OnClientClick="target ='_blank';"
                    AutoCallBack="true" OnClick="btnprnt_Click" AutoUpdateAfterCallBack="true" EnableCallBack="false" />
            </td>
        </tr>
    </table>
