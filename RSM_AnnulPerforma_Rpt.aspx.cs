...
public partial class RSM_Reports_RSM_AnnulPerforma_Rpt : System.Web.UI.Page
{
        ...
        try
        {

            {
                ...
                if (str.ToUpper() == ds.Tables[0].Rows[0]["dbname"].ToString())
                    recieptviewer.ServerReport.ReportPath = "/" + ds.Tables[0].Rows[0]["Dirname"].ToString() + "/RPCAU_Reports" + "/RSM_AnnualPerforma_Rpt";

                else
                    recieptviewer.ServerReport.ReportPath = "/" + ds.Tables[0].Rows[0]["DirnameTest"].ToString() + "/RPCAU_Reports" + "/RSM_AnnualPerforma_Rpt";
                ...
                Response.AddHeader("content-disposition", "attachment; filename=Annual Performa.pdf");
