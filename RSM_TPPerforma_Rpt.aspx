<%@ Page Title="" Language="C#" MasterPageFile="~/UMM/MasterPage.master" AutoEventWireup="true" CodeFile="RSM_TPPerforma_Rpt.aspx.cs" Inherits="RSM_Reports_RSM_FundingAgencywiseProject_Rpt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%">
        <tr>
            <td colspan="6" class="tableheading"><span class="mainheadingborderbottom">TP Performa Report</td>
        </tr>

        <tr>
            <td class="vtext" style="width: 15%">Financial Year</td>
            <td class="colon">:</td>
            <td class="required">
                <Anthem:DropDownList ID="ddlyear" runat="server" CssClass="dropdown" AutoUpdateAfterCallBack="true"></Anthem:DropDownList>*
            </td>

            <td class="vtext">Research Sector Department
            </td>
            <td class="colon">:</td>
            <td class="required">
                <Anthem:DropDownList ID="ddlRsdepartment" runat="server" AutoUpdateAfterCallBack="true" CssClass="dropdown"></Anthem:DropDownList>*
            </td>
        </tr>
        <tr>
            <td colspan="2"></td>
